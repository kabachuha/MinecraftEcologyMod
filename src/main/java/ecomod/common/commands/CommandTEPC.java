	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
		...
		case add:
			...
			if(tep != null)
			{
				...
				sender.addChatMessage(new TextComponentTranslation("commands.ecomod.tepc.add.success", tep.toString()));
		...
		case remove:
			...
			if(EcologyMod.instance.tepc.hasTile(new ResourceLocation(tileId1)))
			{
				...
				sender.addChatMessage(new TextComponentTranslation("commands.ecomod.tepc.remove.success", tileId1));
			}
			else
			{
		...
		case save:
			sender.addChatMessage(new TextComponentTranslation("commands.ecomod.tepc.save"));
		...
		case get:
			...
			{
				sender.addChatMessage(new TextComponentString(EcologyMod.instance.tepc.getTEP(tileId2).toString()));
			}
			else
			{
