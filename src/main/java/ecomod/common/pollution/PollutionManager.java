		...
		if(file != null)
		{
			try
			{
				...
				if(!save.exists())
				{
					...
					EcologyMod.log.error("The pollution manager save file (dimension "+world.provider.dimensionId+") has not been found! The world pollution is set to the initial state!");
