...
public class PollutionEffectIngrRender implements IIngredientRenderer<AnalyzerPollutionEffect>
{
	...
	@Override
	public List<String> getTooltip(Minecraft minecraft, AnalyzerPollutionEffect ingredient)
	{
	...
	@Override
	public FontRenderer getFontRenderer(Minecraft minecraft, AnalyzerPollutionEffect ingredient) {
