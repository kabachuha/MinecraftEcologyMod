...
public class PollutionEffectIngrHelper implements IIngredientHelper<AnalyzerPollutionEffect>
{
	...
	@Override
	public String getResourceId(AnalyzerPollutionEffect ingredient)
	{
		return "ecomod.pollution_effect";
	}

	@Override
	public AnalyzerPollutionEffect copyIngredient(AnalyzerPollutionEffect ingredient)
	{
		return new AnalyzerPollutionEffect(ingredient);
	}
	...
	@Override
	public ItemStack getCheatItemStack(AnalyzerPollutionEffect ingredient) {
