...
public class RecipeCategoryPollutionEffects implements IRecipeCategory<RecipeWrapperPollutionEffect>
{
	...
	public RecipeCategoryPollutionEffects(IGuiHelper guiHelper)
	{
		...
		icon = new IDrawable(){
			private final ResourceLocation texture = new ResourceLocation("minecraft", "textures/blocks/deadbush.png");
			...
			public void draw(Minecraft minecraft, int xOffset, int yOffset) {
				...
				Gui.drawModalRectWithCustomSizedTexture(xOffset, yOffset, 0, 0, 16, 16, 16, 16);
			}
		};
	...
	@Override
	public void setRecipe(IRecipeLayout recipeLayout, RecipeWrapperPollutionEffect recipeWrapper) {
