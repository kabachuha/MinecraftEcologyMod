...
public class EMIntermod
{
	...
	public static void processIMC(ImmutableList<IMCMessage> messages)
	{
		...
		for(IMCMessage m : messages)
		{
			...
			{
				com.google.common.base.Optional<com.google.common.base.Function<TileEntity, Object[]>> op_func = m.getFunctionValue(TileEntity.class, Object[].class);
				...
				else
				{
					...
					EcomodStuff.custom_te_pollution_determinants.add(new Function<TileEntity, Object[]>(){
						@Override
						public Object[] apply(TileEntity t) {
							return op_func.get().apply(t);
						}
					});
				}
			}
