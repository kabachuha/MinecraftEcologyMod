...
public class EcomodAPI
{
	...
	public static boolean addAnalyzerPollutionEffect(final String id, final String header, final String desc, @Nullable final ResourceLocation icon, final PollutionData triggering_pollution, final IAnalyzerPollutionEffect.TriggeringType triggering_type)
	{
